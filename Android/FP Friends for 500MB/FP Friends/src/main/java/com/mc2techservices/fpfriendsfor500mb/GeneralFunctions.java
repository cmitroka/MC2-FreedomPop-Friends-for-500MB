...
public class GeneralFunctions {
	...
	//
	//new GeneralFunctions.AsyncWebCall().execute(AppSpecific.gloWebServiceURL + "/LogLookupRequest", "pUUID="+AppSpecific.gloUUID);
	//
	...
	public static class AsyncWebCall extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String result) {
			...
			String Response = Comm.GetResonseData(result); // "http://AsyncWebCall.mc2techservices.com/Barcodes/9876543321.jpg";
	...
	public static class Cfg{
		public static void WriteSharedPreference(String PrefName, String ValToWrite)
		{
			Context pContext=fpfriendsfor500mb.getAppContext();
		...
		public static String ReadSharedPreference(String PrefName)
		{
			Context pContext=fpfriendsfor500mb.getAppContext();
			String retVal="";
			SharedPreferences prefs = pContext.getSharedPreferences(
		...
		public static void DeleteSharedPreference(String PrefName)
		{
			Context pContext=fpfriendsfor500mb.getAppContext();
			SharedPreferences preferences = pContext.getSharedPreferences("com.mc2techservices.YMCA_Check_In", 0);
			preferences.edit().remove(PrefName).commit();
		}
	}
	public static class Comm{

		public static boolean isInternetConnectionThere(Context context, Activity activity) {
		...
		public static String isConnected(int pSecondsTimeout)
		{
			new AsyncWebCall().execute(AppSpecific.gloWebServiceURL + "/IsConnected", "");
			GeneralFunctions.isOnline="";
			GeneralFunctions.chkRequestType="isConnected";
			int isOnlineCnt=0;
			do {
				isOnlineCnt++;
				SystemClock.sleep(1000);
				if (isOnlineCnt>pSecondsTimeout)break;
			} while (GeneralFunctions.isOnline.equals(""));
			if (GeneralFunctions.isOnline.equals("")) GeneralFunctions.isOnline="0";
			GeneralFunctions.chkRequestType="";
			return GeneralFunctions.isOnline;
		}
		...
		{
			String retVal="";
			String startText= AppSpecific.gloxmlns;
		...
		public static void DownloadImageFromURL(String pURL, String pWhereToSaveImage)
		{
			try {
				String imageName= Subfunctions.GetImageName(pURL, "/");
				String fileLoc= Subfunctions.GetWorkingDirectory()+"/"+ imageName;
				InputStream input;
