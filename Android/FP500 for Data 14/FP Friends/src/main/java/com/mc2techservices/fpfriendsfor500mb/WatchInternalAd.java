...
public class WatchInternalAd extends Activity {
    ...
    {
        String pOfferNum=GeneralFunctions.Text.GetRandomInt(1,6);
        ...
        else if (pOfferNum.equals("2"))
        {
            ...
            txtDescription.setText("Instantly connects to friends for free data - takes two minutes!");
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        else
                        {
                            ...
                            cmdCloseOffer.setText(GeneralFunctions.Conv.IntToString(iDispSecs));
                        }
                    }
                });
            }
