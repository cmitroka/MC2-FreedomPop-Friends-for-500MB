...
public class WatchRewardedAd extends Activity implements RewardedVideoAdListener {
    ...
    private void LoadRewardedVideoAd() {
        AdRequest pAdRequest  = new AdRequest.Builder()
                ...
                .addTestDevice("0CE14084C9625595C9F954AAE637483B")  //white moto e
                .addTestDevice("44F0D84065AAB1963737AF06A4054953")  //moto g6
                .addTestDevice("55FDF28AE1862B6230D77F7295019219")  //black moto e
                .addTestDevice(AdRequest.DEVICE_ID_EMULATOR)
                .build();

        mAd.loadAd("ca-app-pub-2250341510214691/3116915607", pAdRequest);  //live: ca-app-pub-2250341510214691/8849405466 test: ca-app-pub-3940256099942544/5224354917
        if (!mAd.isLoaded())
        {
        }
        ViewVideoAd();
    ...
    public void onRewardedVideoAdClosed() {
        if (pBonus.equals("None"))
        {
            SwitchScreenWhatsTheCatch();
            return;
        }
    ...
    private void SwitchScreenWhatsTheCatch()
    {
        Intent intent = new Intent(this, WhatsTheCatch.class);
        startActivity(intent);
        finish();
