...
public class AdminAppWsBL
{
    ...
    public string GetValueFromAdminTable(string pKey)
    {
        string[][] data = sqlh.GetMultiValuesOfSQL("SELECT pValue FROM tblAdmin WHERE pKey=@P0", pKey);
        string pValue = data[0][0];
        return pValue;
    }
