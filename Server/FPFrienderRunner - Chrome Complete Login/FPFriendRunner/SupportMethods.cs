...
namespace GCGCommon
{
    public static class SupportMethods
    {
        ...
        public static IntPtr GetChromePointer()
        {
            ...
            IntPtr chromeWindow = FindWindow("Chrome_WidgetWin_1", "");
            int z = (int)chromeWindow;
            GCGCommon.SupportMethods.AdjustWindow(chromeWindow, 0, 0, 800, 800);

            int chrome = GetWindow(z,1);
            IntPtr y = (IntPtr)chrome;
            GCGCommon.SupportMethods.AdjustWindow(y, 0, 0, 800, 800);
