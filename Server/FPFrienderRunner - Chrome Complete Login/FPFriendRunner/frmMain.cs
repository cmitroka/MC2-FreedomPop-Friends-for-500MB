...
namespace FPFriender
{
    public partial class frmMain : Form
    {
        ...
        */
        ...
        {
            SupportMethods.LaunchIt(AppDomain.CurrentDomain.BaseDirectory + "\\ChromeClearCache.bat", "", true, true);
        }
        public void RunScript(string pLogin, string pPassword)
        {
            try
            {
                ...
                object vpost = aByte;
                ResetChrome();
                string sPntr = SupportMethods.LaunchIt("chrome", "https://my.freedompop.com/");
                DoDelay(1);
                ...
                DoDelay(1);
                DoHandleTyper("{SELECTALL}" + pLogin);
                DoHandleTyper("{TAB}");
                ...
                DoUI.DoMouseClick(420, 60);
                DoHandleTyper("https://my.freedompop.com/earn-share/friend-invite{ENTER}");
                DoDelay(5);  //We have to wait a few seconds for the page to load to see if we need to reactivate or not.
